...
public final class UploadOptions {
    ...
    public UploadOptions(Map<String, String> params, String mimeType, boolean checkCrc, NetReadyHandler netReadyHandler) {
    ...
    static UploadOptions defaultOptions() {
        return new UploadOptions(null, null, false, null);
    }
