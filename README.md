...
### 直接安装
将sdk jar文件 复制到项目中去，此版本sdk依赖 http://loopj.com/android-async-http/ 1.4.7及以上版本。[下载地址](http://search.maven.org/remotecontent?filepath=com/qiniu/qiniu-android-sdk/)
