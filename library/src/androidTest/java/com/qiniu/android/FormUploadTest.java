...
public class FormUploadTest extends InstrumentationTestCase {
    ...
    @SmallTest
    public void testHostBack() throws Throwable {

        Configuration c = new Configuration.Builder()
                .zone(new Zone("upwelcome1.qiniu.com", Zone.zone0.upHostBackup, Zone.zone0.upIp))
                .upPort(8888)
                .build();
        ...
        _up.put("hello".getBytes(), expectKey, TestConfig.token, new UpCompletionHandler() {
            public void complete(String k, ResponseInfo rinfo, JSONObject response) {
                Log.i("qiniutest", k + rinfo);
                key = k;
                info = rinfo;
    ...
    public void testIpBack() throws Throwable {
        ...
        Configuration c = new Configuration.Builder()
                .zone(new Zone("upwelcome1.qiniu.com", "welcome1.qiniudd.com", Zone.zone0.upIp))
                .upPort(8888)
                .build();
        UploadManager _up = new UploadManager(c);
        final String expectKey = "你好;\"\r\n\r\n\r\n";
